...
## Corpus Check
- 68 files · ~352,451 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 536 nodes · 926 edges · 68 communities (42 shown, 26 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de5eece2`
...
Cohesion: 0.21
Nodes (12): allSongs(), closeSongs(), karaBuild(), karaStop(), loadYT(), lsnSaveDone(), lsnUid(), openSong() (+4 more)
