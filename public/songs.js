/* ===================== РАЗБОР ПЕСЕН (караоке, по слогам) =====================
   ...
   Схема:
     ...
     verses[]    — куплеты.
       ...
       lines[]   — {t, s, c, w:[{k,r,rr,ru,en}]}: строка с таймкодом + разбор
                   k=слово, r/rr=транскрипция по слогам, ru/en=перевод слова
                   s  — {ru,en} СМЫСЛОВОЙ перевод ЭТОЙ строки. Заливается синхронно
                        с пением (правка 23.07): человек видит не только какие слова
                        поют, но и что они означают вместе, прямо в момент звучания.
                   c  — {ru,en} необязательно: почему именно эта компоновка слов даёт
                        такой смысл. Раскрывается по 🔗, чтобы не мешать во время песни.
========================================================================= */
window.SONGS = [
  {
    id: 'spring_day',
    ...
    verses: [
      ...
      },
      {
        ...
        lines: [
          { t: 34.89,
            s: { ru: 'Здесь сплошная зима — даже в августе приходит зима.', en: 'It is all winter here — even in August, winter comes.' },
            w: [
          ...
          { t: 39.58,
            s: { ru: 'Сердце мчится сквозь время — одинокий «Сквозь снег».', en: 'My heart races through time — a Snowpiercer left all alone.' },
            c: { ru: '설국 «снежная страна» + 열차 «поезд» порознь — бессмыслица. Вместе 설국열차 — корейское название фильма «Сквозь снег»: поезд, вечно кружащий по замёрзшей планете. Одно слово вместо абзаца про «застрял в бесконечной зиме».', en: '설국 “snow country” + 열차 “train” apart is nonsense. Together 설국열차 is the Korean title of Snowpiercer: a train circling a frozen planet forever. One word instead of a paragraph about being stuck in an endless winter.' },
            w: [
          ...
          { t: 43.82,
            s: { ru: 'Взял бы тебя за руку и ушёл на другой конец Земли, лишь бы кончить эту зиму.', en: 'Holding your hand I would go to the far side of the Earth, just to end this winter.' },
            w: [
          ...
          { t: 49.02,
            s: { ru: 'Сколько тоски должно выпасть снегом, чтобы пришёл тот весенний день, friend?', en: 'How much longing must fall like snow before that spring day comes, friend?' },
            c: { ru: '봄 «весна» + 날 «день» — не прогноз погоды. 봄날 значит «пора, когда между людьми снова станет тепло».', en: '봄 “spring” + 날 “day” is not a weather forecast. 봄날 means “the time when things get warm between people again”.' },
            w: [
      ...
      },
      {
        ...
        lines: [
          { t: 53.58,
            s: { ru: 'Как крошечная пылинка, блуждающая в пустоте.', en: 'Like a tiny speck of dust drifting in the void.' },
            w: [
          ...
          { t: 62.38,
            s: { ru: 'Будь я летящим снегом — я бы добрался до тебя чуть быстрее.', en: 'If I were the flurrying snow, I could reach you a little faster.' },
            c: { ru: 'Хвост 닿을 수 있을 텐데 — три куска: 닿다 «дотронуться» + -ㄹ 수 있다 «мочь» + -텐데 «было бы, да…». Первые два дают «смог бы дотянуться», а -텐데 добавляет то, чего нет ни в одном слове: сожаление и невозможность. «Дотянулся бы… но я не снег».', en: 'The tail 닿을 수 있을 텐데 is three pieces: 닿다 “to reach” + -ㄹ 수 있다 “to be able” + -텐데 “it would be, but…”. The first two give “I could reach you”; -텐데 adds what no single word carries: regret and impossibility. “I would reach you… but I am not snow.”' },
            w: [
